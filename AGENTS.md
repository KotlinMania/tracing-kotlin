...
This file is the quick-reference operating contract for tracing-kotlin. The longer
...
tracing-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tracing`](https://crates.io/crates/tracing). Upstream Rust is the behavioral oracle while the
