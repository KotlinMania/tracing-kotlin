...
kotlin {
    ...
    swiftExport {
        moduleName = "Tracing"
        flattenPackage = "io.github.kotlinmania.tracing"
    }

    android {
        namespace = "io.github.kotlinmania.tracing"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                // Upstream src/lib.rs does `pub use log::*` under the `log` feature.
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tracing-kotlin", version.toString())

    pom {
        name.set("tracing-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/tracin - Application-level tracing for Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tracing-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tracing-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tracing-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tracing-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTracingXCFramework",
    "assembleTracingDebugXCFramework",
    "assembleTracingReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTracingXCFramework",
    "assembleReleaseIosFatFrameworkForTracingXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTracingXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTracingXCFramework",
    "assembleDebugMacosFatFrameworkForTracingXCFramework",
    "assembleReleaseMacosFatFrameworkForTracingXCFramework",
    "assembleDebugTvosFatFrameworkForTracingXCFramework",
    "assembleReleaseTvosFatFrameworkForTracingXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTracingXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTracingXCFramework",
    "assembleDebugWatchosFatFrameworkForTracingXCFramework",
    "assembleReleaseWatchosFatFrameworkForTracingXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTracingXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTracingXCFramework",
